...
const LOCATIONS = [
  ...
  {
    label: 'Mumbai (Branch)',
    address: '307, OM GOLDEN BUILDING, Shaikh Memon Street Nearby Landmark COTTON EXCHANGE, Kalbadevi, Mumbai, Maharashtra, Pin - 400002',
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-3">
              ...
              {/* Instagram */}
              <a
                href="https://www.instagram.com/nabagold1992?igsh=cHRhcnRyajBoN283"
                target="_blank"
                rel="noopener noreferrer"
              ...
              {/* Gmail */}
              <a
                href="mailto:naba.shaw1992@gmail.com"
                aria-label="Email"
                className="w-9 h-9 rounded-full border border-white/10 flex items-center justify-center text-gray-400 hover:border-[#EA4335] hover:text-[#EA4335] hover:bg-[#EA4335]/10 transition-all duration-200"
              >
              ...
              {LOCATIONS.map((loc) => (
                <div key={loc.label} className="space-y-2.5">
                  ...
                  <div className="flex flex-col gap-1.5">
                    <a href={`tel:${loc.tel}`} className="flex items-center gap-2 group">
                      <Phone className="h-3.5 w-3.5 text-gold-400 shrink-0 group-hover:text-gold-300 transition-colors" />
                      <span className="text-gray-400 text-xs group-hover:text-white transition-colors">{loc.phone}</span>
                    </a>
                    {loc.phone1 && loc.tel1 && (
                      <a href={`tel:${loc.tel1}`} className="flex items-center gap-2 group">
                        <Phone className="h-3.5 w-3.5 text-gold-400 shrink-0 group-hover:text-gold-300 transition-colors" />
                        <span className="text-gray-400 text-xs group-hover:text-white transition-colors">{loc.phone1}</span>
                      </a>
                    )}
                  </div>
                </div>
