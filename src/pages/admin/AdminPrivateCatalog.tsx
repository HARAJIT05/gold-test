                  ...
                  <fieldset>
                    ...
                    <div className="flex flex-col gap-6">
                      ...
                      <label className="flex items-center gap-3 cursor-pointer group">
                         <button
                           type="button"
                           onClick={() => setCurrentProduct({...currentProduct, showPrice: !currentProduct.showPrice})}
                           className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 ${currentProduct.showPrice ? 'bg-emerald-500' : 'bg-gray-200'}`}
                         >
                           <span className={`inline-block h-4 w-4 transform rounded-full bg-navy-900 transition-transform ${currentProduct.showPrice ? 'translate-x-6' : 'translate-x-1'}`} />
                         </button>
                         <div className="flex flex-col">
