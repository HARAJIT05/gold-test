          ...
          <div className="my-24 grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="pl-0 md:pl-8">
              ...
              <p className="mb-6 text-sm leading-relaxed text-gray-400">
                A Karigar is more than a jeweler; they are a guardian of tradition. For over three decades, our workshop has transformed raw, pure gold into heirloom pieces passed down through generations.
              </p>
              <p className="text-sm leading-relaxed text-gray-400">
                Every stroke of the hammer, every delicate filigree wire, and every polished surface tells a story of dedication. We don't just manufacture jewelry; we sculpt memories.
              </p>
            </div>
          </div>
